    ...
    <div className="App">
      <div className='result-block'>
        ...
        <div className="summary right">
          ...
          <div className="summary-block reaction">
            ...
            <p className='mark'>80<p className='hundred'>/ 100</p></p>
          </div>

          <div className="summary-block memory">
            <div className='svg-and-title'>
            ...
            <p className='mark'>92<p className='hundred'>/ 100</p></p>
          </div>

          <div className="summary-block verbal">
            <div className='svg-and-title'>
            ...
            <p className='mark'>61<p className='hundred'>/ 100</p></p>
          </div>

          <div className="summary-block visual">
            <div className='svg-and-title'>
            ...
            <p className='mark'>72 <p className='hundred'> / 100</p></p>
          </div>
